<template>
  ...
  <section>  
    ...
    <section>
      <!-- This example requires Tailwind CSS v2.0+ -->
      <div class="z-10 relative bg-white overflow-hidden">
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <form method="POST" action="#login">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-14 w-9 text-gray-400" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                </div>
                                <input id="username" class="block pr-10 shadow appearance-none border-2 border-orange-100 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-orange-500 transition duration-500 ease-in-out" placeholder="your message" />
                            </div>
                            <strong class="text-red-500 text-xs italic">Type in Your Message</strong>
                        </div>
   ...
   <div class="bg-gradient-to-b from-gray-800 to-gray-800 h-96 w-full">
            <div class="md:px-20 px-4 py-8">
                <div class="flex items-center justify-between">
                    <div> 
                       <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/contact1-svg1.svg" alt="logo"/>
                    </div>
                ...
                <nav class="lg:hidden relative z-40">
                    <div class="w-full">
                        <div class="visible flex items-center">
                            <ul id="list" class="hidden p-2 bg-white absolute rounded top-0 left-0 right-0 shadow mt-6">
                                <li class="flex cursor-pointer text-gray-600 dark:text-gray-200 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                ...
                                <li class="flex cursor-pointer text-gray-600 dark:text-gray-200 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                                    <a href="javascript:void(0)">
